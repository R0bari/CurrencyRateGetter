...
namespace RateGetters.Tests
{
    public class RateGetterTests
    {
        ...
        public void TestSuccessfulCbrRateGetterSingleResult()
        {
            ...
            Assert.Equal(CurrencyCodesEnum.Usd, rateResultForToday.Result.Code);
        }
        ...
        public void TestSuccessfulCbrRateGetterPeriodResult()
        {
            ...
            var periodRateResult = _rateGetter.GetRateForPeriod(holidayDate, periodStart, CurrencyCodesEnum.Usd);
